...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <form runat="server">
        ...
        <div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Quản Lý Khách Hàng</h1>
                </div>
            </div>
            <!--/.row-->
                            ...
                            <div class="bootstrap-table">
                                ...
                                <div class="fixed-table-container">
                                    ...
                                    <div class="fixed-table-body">
                                        ...
                                        <table id="tblData" data-toggle="table" data-url="tables/data1.json" data-show-refresh="true" data-show-toggle="true" data-show-columns="true" data-search="true" data-select-item-name="toolbar1" data-pagination="true" data-sort-name="name" data-sort-order="desc" class="table table-hover">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th style="">
                                                        <div class="th-inner sortable">Mã KH</div>
                                                        <div class="fht-cell"></div>
                                                    </th>
                                                    <th style="">
                                                        <div class="th-inner sortable">Họ Tên</div>
                                                        <div class="fht-cell"></div>
                                                    </th>
                                                    <th style="">
                                                    ...
                                                    <th style="">
                                                        <div class="th-inner sortable">Địa chỉ</div>
                                                        <div class="fht-cell"></div>
                                                    </th>
                                                    <th style="">
                                                    ...
                                                    <th style="">
                                                        <div class="th-inner sortable">Số Thẻ Cũ</div>
                                                        <div class="fht-cell"></div>
                                                    </th>
                                                    <th style="">
                                                        <div class="th-inner sortable">Loại Thẻ</div>
                                                        <div class="fht-cell"></div>
                                                    </th>
                                                    <th style="">
                                                        <div class="th-inner sortable">Điểm Thưởng</div>
                                                        <div class="fht-cell"></div>
                                                    </th>
                                                </tr>
                                            </thead>
                                            <tbody id="tbody" runat="server">
                                                <tr class="no-records-found" id="no_records" runat="server">
                                                    <td colspan="4">Không tìm thấy khách hàng nào</td>
                                                </tr>
                                            </tbody>
                                        </table>
                                    </div>
                                    <div class="fixed-table-pagination">
                                        ...
                                        <div class="pull-right pagination">
                                            <ul class="pagination">
                                                <li class="page-first disabled"><a runat="server" id="pageFirst" onserverclick="pageFirst_ServerClick" href="javascript:void(0)">&lt;&lt;</a></li>
