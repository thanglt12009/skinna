...
namespace SkinCare.Web.UI
{
    ...
    /// <summary>
    /// A strongly typed repeater control for the <see cref="UserRepeater"/> Type.
    /// </summary>
...
//      }
		...
		protected override int CreateChildControls(System.Collections.IEnumerable dataSource, bool dataBinding)
         ...
         if (dataBinding)
         {
			...
			if (dataSource != null)
			{
				...
				{
						SkinCare.Entities.User entity = o as SkinCare.Entities.User;
	...
	{
		private SkinCare.Entities.User _entity;
        ...
        /// Initializes a new instance of the <see cref="T:UserItem"/> class.
        /// </summary>
		public UserItem(SkinCare.Entities.User entity)
			: base()
		{
			_entity = entity;
		}
		...
		{
			get { return _entity.Salt; }
		}

        /// <summary>
        /// Gets a <see cref="T:SkinCare.Entities.User"></see> object
        /// </summary>
        /// <value></value>
        [System.ComponentModel.Bindable(true)]
        public SkinCare.Entities.User Entity
        {
            get { return _entity; }
        }
	}
