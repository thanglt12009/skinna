/*
	...
	Important: Do not modify this file. Edit the file SqlKhoHangSanPhamProvider.cs instead.
*/
...
namespace SkinCare.Data.SqlClient
{
	...
	///</summary>
	public abstract partial class SqlKhoHangSanPhamProviderBase : KhoHangSanPhamProviderBase
	{
		#region Declarations
		...
		/// <summary>
		/// Creates a new <see cref="SqlKhoHangSanPhamProviderBase"/> instance.
		/// </summary>
		public SqlKhoHangSanPhamProviderBase()
		{
		}
	...
	public SqlKhoHangSanPhamProviderBase(string connectionString, bool useStoredProcedure, string providerInvariantName)
	{
    ...
    public string ProviderInvariantName
    {
		...
		public override TList<KhoHangSanPham> Find(TransactionManager transactionManager, string whereClause, int start, int pageLength, out int count)
		{
			count = -1;
			if (whereClause.IndexOf(";") > -1)
				return new TList<KhoHangSanPham>();
	
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.tblKhoHangSanPham_Find", _useStoredProcedure);
		...
		database.AddInParameter(commandWrapper, "@IsDeleted", DbType.Boolean, DBNull.Value);
	   		...
	   		foreach (string clause in clauses)
			{
				...
				if (clause.Trim().StartsWith("tensanpham ") || clause.Trim().StartsWith("tensanpham="))
				{
				...
				{
					database.SetParameterValue(commandWrapper, "@SoLuongNhapVao", 
						clause.Trim().Remove(0,14).Trim().TrimStart(equalSign).Trim().Trim(singleQuote));
					continue;
				}
				if (clause.Trim().StartsWith("soluongbanra ") || clause.Trim().StartsWith("soluongbanra="))
				{
					database.SetParameterValue(commandWrapper, "@SoLuongBanRa", 
						clause.Trim().Remove(0,12).Trim().TrimStart(equalSign).Trim().Trim(singleQuote));
					continue;
				}
				if (clause.Trim().StartsWith("soluongtonkho ") || clause.Trim().StartsWith("soluongtonkho="))
				{
					database.SetParameterValue(commandWrapper, "@SoLuongTonKho", 
						clause.Trim().Remove(0,13).Trim().TrimStart(equalSign).Trim().Trim(singleQuote));
					continue;
				}
				if (clause.Trim().StartsWith("ngaynhaphang ") || clause.Trim().StartsWith("ngaynhaphang="))
				{
					database.SetParameterValue(commandWrapper, "@NgayNhapHang", 
						clause.Trim().Remove(0,12).Trim().TrimStart(equalSign).Trim().Trim(singleQuote));
					continue;
				}
			...
			//Create Collection
			TList<KhoHangSanPham> rows = new TList<KhoHangSanPham>();
		...
		/// <param name="count">out. The number of rows that match this query.</param>
		/// <returns>Returns a typed collection of SkinCare.Entities.KhoHangSanPham objects.</returns>
		public override TList<KhoHangSanPham> Find(TransactionManager transactionManager, IFilterParameterCollection parameters, string orderBy, int start, int pageLength, out int count)
		{
			...
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.tblKhoHangSanPham_Find_Dynamic", typeof(KhoHangSanPhamColumn), filter, orderBy, start, pageLength);
        ...
        /// <exception cref="System.Data.DataException">The <paramref name="transactionManager"/> is not open.</exception>
        /// <exception cref="System.Data.Common.DbException">The command could not be executed.</exception>
		public override TList<KhoHangSanPham> GetAll(TransactionManager transactionManager, int start, int pageLength, out int count)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.tblKhoHangSanPham_Get_List", _useStoredProcedure);
		...
		/// <remarks></remarks>
		/// <returns>Returns a typed collection of SkinCare.Entities.KhoHangSanPham objects.</returns>
		public override TList<KhoHangSanPham> GetPaged(TransactionManager transactionManager, string whereClause, string orderBy, int start, int pageLength, out int count)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.tblKhoHangSanPham_GetPaged", _useStoredProcedure);
		...
		public override SkinCare.Entities.KhoHangSanPham GetByMaSanPham(TransactionManager transactionManager, System.String _maSanPham, int start, int pageLength, out int count)
		{
			...
			{
				//Provider Data Requesting Command Event
				OnDataRequesting(new CommandEventArgs(commandWrapper, "GetByMaSanPham", tmp)); 
				...
				//Provider Data Requested Command Event
				OnDataRequested(new CommandEventArgs(commandWrapper, "GetByMaSanPham", tmp));
			}
			finally 
			{
				if (reader != null) 
		...
		/// </remarks>	
		public override void BulkInsert(TransactionManager transactionManager, TList<SkinCare.Entities.KhoHangSanPham> entities)
		{
			...
			DataColumn col4 = dataTable.Columns.Add("SoLuongBanRa", typeof(System.Int32));
			col4.AllowDBNull = true;		
			DataColumn col5 = dataTable.Columns.Add("SoLuongTonKho", typeof(System.Int32));
			col5.AllowDBNull = true;		
			DataColumn col6 = dataTable.Columns.Add("NgayNhapHang", typeof(System.DateTime));
			...
			foreach(SkinCare.Entities.KhoHangSanPham entity in entities)
			{
				...
				DataRow row = dataTable.NewRow();
					...
					row["SoLuongBanRa"] = entity.SoLuongBanRa.HasValue ? (object) entity.SoLuongBanRa  : System.DBNull.Value;
							
				
					row["SoLuongTonKho"] = entity.SoLuongTonKho.HasValue ? (object) entity.SoLuongTonKho  : System.DBNull.Value;
							
				
					row["NgayNhapHang"] = entity.NgayNhapHang.HasValue ? (object) entity.NgayNhapHang  : System.DBNull.Value;
        ...
        /// <exception cref="System.Data.DataException">The <paramref name="transactionManager"/> is not open.</exception>
        /// <exception cref="System.Data.Common.DbException">The command could not be executed.</exception>
		public override bool Insert(TransactionManager transactionManager, SkinCare.Entities.KhoHangSanPham entity)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
        ...
        /// <exception cref="System.Data.DataException">The <paramref name="transactionManager"/> is not open.</exception>
        /// <exception cref="System.Data.Common.DbException">The command could not be executed.</exception>
		public override bool Update(TransactionManager transactionManager, SkinCare.Entities.KhoHangSanPham entity)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
