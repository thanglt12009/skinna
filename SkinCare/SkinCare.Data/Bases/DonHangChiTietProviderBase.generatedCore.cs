...
{	
	...
	{		
		...
		#region _tblDonHangChiTiet_GetAllProducts 
		
		/// <summary>
		///	This method wrap the '_tblDonHangChiTiet_GetAllProducts' stored procedure. 
		/// </summary>
		/// <param name="maKhachHang"> A <c>System.Int32?</c> instance.</param>
		/// <remark>This method is generate from a stored procedure.</remark>
		/// <returns>A <see cref="DataSet"/> instance.</returns>
		public DataSet GetAllProducts(System.Int32? maKhachHang)
		{
			return GetAllProducts(null, 0, int.MaxValue , maKhachHang);
		}
		...
		/// <remark>This method is generate from a stored procedure.</remark>
		/// <returns>A <see cref="DataSet"/> instance.</returns>
		public DataSet GetAllProducts(int start, int pageLength, System.Int32? maKhachHang)
		{
			return GetAllProducts(null, start, pageLength , maKhachHang);
		}
		...
		/// <remark>This method is generate from a stored procedure.</remark>
		/// <returns>A <see cref="DataSet"/> instance.</returns>
		public DataSet GetAllProducts(TransactionManager transactionManager, System.Int32? maKhachHang)
		{
			return GetAllProducts(transactionManager, 0, int.MaxValue , maKhachHang);
		}
		...
		/// <remark>This method is generate from a stored procedure.</remark>
		/// <returns>A <see cref="DataSet"/> instance.</returns>
		public abstract DataSet GetAllProducts(TransactionManager transactionManager, int start, int pageLength , System.Int32? maKhachHang);
